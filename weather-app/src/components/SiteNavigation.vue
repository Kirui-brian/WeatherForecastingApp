        ...
        <nav class="container flex flex-col sm:flex-row items-center gap-4 text-white py-6">
            <RouterLink :to="{ name: 'home' }">
                <div class="flex items-center gap-3">
                    ...
                    <p class="text-2xl">Weather Forecasting Application</p>
                </div>
            </RouterLink>

            <div class="flex gap-3 flex-1 justify-right">
            ...
            @close-modal="toggleModal">
                <div class="text-black">
                    ...
                    <p class="mb-4">The Weather Forecasting Application allows you to track the current and future weather of cities of your choosing.</p>
                    <h2 class="text-2xl">How it works:</h2>
                    <ol class="list-disc list-inside mb-4">
                        <li>Search for your location or city by entering the name into the search bar.</li>
